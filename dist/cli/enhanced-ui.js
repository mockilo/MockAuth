...
class EnhancedCLI {
    ...
    createInteractiveConfig() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (answers.createDefaultUsers) {
                ...
                const userAnswers = yield this.promptWithEsc(userQuestions);
    ...
    // 🎨 Loading Animation
    showLoading(text_1) {
        return __awaiter(this, arguments, void 0, function* (text, duration = 2000) {
    ...
    formatTable(headers, rows) {
        const maxWidths = headers.map((_, i) => Math.max(headers[i].length, ...rows.map((row) => { var _a; return ((_a = row[i]) === null || _a === void 0 ? void 0 : _a.length) || 0; })));
